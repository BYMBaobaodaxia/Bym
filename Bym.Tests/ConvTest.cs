...
namespace Bym.Tests
{
    ...
    public class ConvTest
    {
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToInt(null));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToInt(""));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToInt("1A"));
        }
        ...
        {
            Assert.AreEqual(1, Bym.Conv.ToInt("1"));
            Assert.AreEqual(1778020, Bym.Conv.ToInt("1778019.7801684"));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToIntOrNull(null));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToIntOrNull(""));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToIntOrNull("1A"));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToIntOrNull("0"));
        }
        ...
        {
            Assert.AreEqual(1, Bym.Conv.ToIntOrNull("1"));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToDouble(null));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToDouble(""));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToDouble("1A"));
        }
        ...
        {
            Assert.AreEqual(1.2, Bym.Conv.ToDouble("1.2"));
        }
        ...
        {
            Assert.AreEqual(12.36, Bym.Conv.ToDouble("12.355", 2));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToDoubleOrNull(null));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToDoubleOrNull(""));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToDoubleOrNull("1A"));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToDoubleOrNull("0"));
        }
        ...
        {
            Assert.AreEqual(1.2, Bym.Conv.ToDoubleOrNull("1.2"));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToDecimal(null));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToDecimal(""));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToDecimal("1A"));
        }
        ...
        {
            Assert.AreEqual(1.2M, Bym.Conv.ToDecimal("1.2"));
        }
        ...
        public void TestToDecimal_DigitsIs2()
        {
            ...
            Assert.AreEqual(12.24M, Bym.Conv.ToDecimal("12.235", 2));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToDecimalOrNull(null));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToDecimalOrNull(""));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToDecimalOrNull("1A"));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToDecimalOrNull("1A", 2));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToDecimalOrNull("0"));
        }
        ...
        {
            Assert.AreEqual(1.2M, Bym.Conv.ToDecimalOrNull("1.2"));
        }
        ...
        {
            Assert.AreEqual(12.24M, Bym.Conv.ToDecimalOrNull("12.235", 2));
        }
        ...
        {
            Assert.AreEqual(Guid.Empty, Bym.Conv.ToGuid(null));
        }
        ...
        {
            Assert.AreEqual(Guid.Empty, Bym.Conv.ToGuid(""));
        }
        ...
        {
            Assert.AreEqual(Guid.Empty, Bym.Conv.ToGuid("1A"));
        }
        ...
        {
            Assert.AreEqual(new Guid("B9EB56E9-B720-40B4-9425-00483D311DDC"), Bym.Conv.ToGuid("B9EB56E9-B720-40B4-9425-00483D311DDC"));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToGuidOrNull(null));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToGuidOrNull(""));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToGuidOrNull("1A"));
        }
        ...
        {
            Assert.AreEqual(new Guid("B9EB56E9-B720-40B4-9425-00483D311DDC"), Bym.Conv.ToGuidOrNull("B9EB56E9-B720-40B4-9425-00483D311DDC"));
        }
        ...
        {
            Assert.AreEqual(0, Bym.Conv.ToGuidList("").Count);
        }
        ...
        {
            Assert.AreEqual(1, Bym.Conv.ToGuidList("83B0233C-A24F-49FD-8083-1337209EBC9A,").Count);
        }
        ...
        public void TestToGuidList_MiddleIsComma()
        {
            ...
            Assert.AreEqual(2, Bym.Conv.ToGuidList(guid).Count);
            Assert.AreEqual(new Guid("83B0233C-A24F-49FD-8083-1337209EBC9A"), Bym.Conv.ToGuidList(guid)[0]);
            Assert.AreEqual(new Guid("EAB523C6-2FE7-47BE-89D5-C6D440C3033A"), Bym.Conv.ToGuidList(guid)[1]);
        }
        ...
        public void TestToGuidList_1Guid()
        {
            ...
            Assert.AreEqual(1, Bym.Conv.ToGuidList(guid).Count);
            Assert.AreEqual(new Guid(guid), Bym.Conv.ToGuidList(guid)[0]);
        }
        ...
        {
            Assert.AreEqual(DateTime.MinValue, Bym.Conv.ToDate(null));
        }
        ...
        {
            Assert.AreEqual(DateTime.MinValue, Bym.Conv.ToDate(""));
        }
        ...
        {
            Assert.AreEqual(DateTime.MinValue, Bym.Conv.ToDate("1A"));
        }
        ...
        {
            Assert.AreEqual(new DateTime(2000, 1, 1), Bym.Conv.ToDate("2000-1-1"));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToDateOrNull(null));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToDateOrNull(""));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToDateOrNull("1A"));
        }
        ...
        {
            Assert.AreEqual(new DateTime(2000, 1, 1), Bym.Conv.ToDateOrNull("2000-1-1"));
        }
        ...
        {
            Assert.AreEqual(false, Bym.Conv.ToBool(null));
        }
        ...
        {
            Assert.AreEqual(false, Bym.Conv.ToBool(""));
        }
        ...
        {
            Assert.AreEqual(false, Bym.Conv.ToBool("1A"));
        }
        ...
        {
            Assert.AreEqual(false, Bym.Conv.ToBool("0"));
            Assert.AreEqual(false, Bym.Conv.ToBool("否"));
            Assert.AreEqual(false, Bym.Conv.ToBool("no"));
            Assert.AreEqual(false, Bym.Conv.ToBool("No"));
            Assert.AreEqual(false, Bym.Conv.ToBool("false"));
            Assert.AreEqual(false, Bym.Conv.ToBool("False"));
        }
        ...
        {
            Assert.AreEqual(true, Bym.Conv.ToBool("1"));
            Assert.AreEqual(true, Bym.Conv.ToBool("是"));
            Assert.AreEqual(true, Bym.Conv.ToBool("yes"));
            Assert.AreEqual(true, Bym.Conv.ToBool("Yes"));
            Assert.AreEqual(true, Bym.Conv.ToBool("true"));
            Assert.AreEqual(true, Bym.Conv.ToBool("True"));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToBoolOrNull(null));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToBoolOrNull(""));
        }
        ...
        {
            Assert.IsNull(Bym.Conv.ToBoolOrNull("1A"));
        }
        ...
        {
            Assert.AreEqual(false, Bym.Conv.ToBoolOrNull("0"));
            Assert.AreEqual(false, Bym.Conv.ToBoolOrNull("否"));
            Assert.AreEqual(false, Bym.Conv.ToBoolOrNull("no"));
            Assert.AreEqual(false, Bym.Conv.ToBoolOrNull("No"));
            Assert.AreEqual(false, Bym.Conv.ToBoolOrNull("false"));
            Assert.AreEqual(false, Bym.Conv.ToBoolOrNull("False"));
        }
        ...
        {
            Assert.AreEqual(true, Bym.Conv.ToBoolOrNull("1"));
            Assert.AreEqual(true, Bym.Conv.ToBoolOrNull("是"));
            Assert.AreEqual(true, Bym.Conv.ToBoolOrNull("yes"));
            Assert.AreEqual(true, Bym.Conv.ToBoolOrNull("Yes"));
            Assert.AreEqual(true, Bym.Conv.ToBoolOrNull("true"));
            Assert.AreEqual(true, Bym.Conv.ToBoolOrNull("True"));
        }
        ...
        {
            Assert.AreEqual(string.Empty, Bym.Conv.ToString(null));
        }
        ...
        {
            Assert.AreEqual(string.Empty, Bym.Conv.ToString(" "));
        }
        ...
        {
            Assert.AreEqual("1", Bym.Conv.ToString(1));
        }
